...
const ITEM_DATA = [
  ...
  {id:7,name:'Ancient Manuscript',desc:'A thin volume packed with dense wisdom. EXP +10000.',price:3000,type:'use',effect:10000,stat:'exp',target:'self',minFloor:51,maxFloor:9999},
  ...
  {id:10,name:'Old MC',desc:'A long-unredeemed virtual coin. No one remembers when it was bought. Deals 10 HP damage to enemy.',price:10,type:'use',effect:-10,stat:'hp',target:'enemy',minFloor:1,maxFloor:9999},
  ...
  {id:19,name:'Shiny MC',desc:'A brand-new virtual coin fresh off the press. A rare item good for investing or throwing. Deals 200 HP damage to enemy.',price:240,type:'use',effect:-200,stat:'hp',target:'enemy',minFloor:30,maxFloor:9999},
  {id:20,name:'Giant Bear Plushie',desc:'A life-size Bear plushie. Great for hugging or swinging around as a weapon. Boosts AT by 6 stages.',price:800,type:'use',effect:6,stat:'at',target:'self',minFloor:9999,maxFloor:9999},
  ...
  {id:28,name:'Security Software',desc:'Defender is enough these days, but it\'s good to be prepared. Boosts DF by 2 stages.',price:200,type:'use',effect:2,stat:'df',target:'self',minFloor:21,maxFloor:9999},
  ...
  {id:30,name:'Manju (Shrine Maiden Flavor)',desc:'A red manju that A round, sweet bun filled with bean paste. Filled with fine bean paste. Restores HP to 30 and raises SP and DF each by 1 stage.',price:1000,type:'use',effect:1,stat:'custom1',target:'self',minFloor:26,maxFloor:9999},
  {id:31,name:'Manju (Witch Flavor)',desc:'A yellow manju that A round, sweet bun filled with bean paste. Filled with fine bean paste. Deals 30 HP damage to enemy and raises your SP and AT each by 1 stage.',price:1000,type:'use',effect:1,stat:'custom2',target:'self',minFloor:26,maxFloor:9999},
  ...
  {id:33,name:'Dark Blade Manutar Sword\u0414',desc:'A legendary evil blade on the verge of corruption. Deals 800 HP damage to enemy without consuming itself.',price:1000000000000,type:'use',effect:-800,stat:'nousedhp',target:'enemy',minFloor:9999,maxFloor:9999},
  {id:34,name:'Manju (Demon Flavor)',desc:'A sinister blue manju that A round, sweet bun filled with bean paste. Filled with ominous bean paste. Fully restores HP and raises all stats by 2 stages each.',price:10000,type:'use',effect:2,stat:'custom3',target:'self',minFloor:201,maxFloor:9999},
  ...
  {id:39,name:'Sparkling Juice',desc:'Can\'t stop drinking. Restores 100 HP.',price:150,type:'use',effect:100,stat:'hp',target:'self',minFloor:21,maxFloor:50},
  ...
  {id:42,name:'Crimson Fungus',desc:'Taking it makes you big and heavy. Lowers enemy SP by 2 stages.',price:180,type:'use',effect:-2,stat:'sp',target:'enemy',minFloor:9999,maxFloor:9999},
  {id:43,name:'Fire Bloom',desc:'Taking it sets you ablaze; you cry "I\'m burning!!" and promptly perish. Deals 75 HP damage to enemy.',price:75,type:'use',effect:-75,stat:'hp',target:'enemy',minFloor:9999,maxFloor:9999},
...
const MONSTER_DATA = [
  ...
  {id:13,name:'Hiki Bat',maxLv:1,drops:[1,1,1,1,5,6],coinRange:[4,11],expRange:[6,18],hp1:12,at1:4,df1:12,sp1:4,type:'normal',bossDialog:['\n (-＿-) "......just want to be left alone......"'],floorRange:[1,9],patterns:[{a:'enemysearch'},{a:'counter'},{a:'guard'},{a:'counter'},{a:'heal'}],weakness:12,bgm:null,growth:{hp:1.5,at:1.12,df:1.08,sp:1.05},healRate:0.1},
  ...
  {id:19,name:'Anti-Bear (OP)',maxLv:5,drops:[53,20,20,8,8,27,27,6],coinRange:[220,400],expRange:[340,500],hp1:120,at1:50,df1:16,sp1:80,type:'doubleboss',bossDialog:[],floorRange:[100,9999],patterns:[{a:'attack'},{a:'charge'},{a:'charge'},{a:'charge'},{a:'enemycharge'},{a:'enemyguard'},{a:'critical'},{a:'attack'},{a:'guard'},{a:'enemyitem'},{a:'attack'},{a:'attack'},{a:'guard'},{a:'charge'},{a:'heal'}],weakness:27,bgm:'./BGM/battlebgm_irregular.ogg',growth:{hp:5,at:1.25,df:1.2,sp:1.1},healRate:0.2},
  {id:20,name:'Metal Bear',maxLv:3,drops:[53,13,13,20,20,8,8],coinRange:[100,300],expRange:[1500,4500],hp1:80,at1:18,df1:9999,sp1:60,type:'undead',bossDialog:[],floorRange:[101,9999],patterns:[{a:'enemyitem'},{a:'attack'},{a:'enemyguard'},{a:'critical'},{a:'attack'},{a:'attack'},{a:'counter'},{a:'enemyitem'},{a:'attack'},{a:'critical'},{a:'heal'},{a:'heal'},{a:'selfdestruct'}],weakness:10,bgm:'./BGM/battlebgm_rare.ogg',growth:{hp:1.01,at:1.12,df:1.08,sp:1.05},healRate:0.25},
  {id:21,name:'Gold Bear',maxLv:3,drops:[53,19,19,20,20,8,8],coinRange:[1000,3000],expRange:[150,450],hp1:100,at1:36,df1:9999,sp1:30,type:'double',bossDialog:[],floorRange:[101,9999],patterns:[{a:'charge'},{a:'charge'},{a:'enemycharge'},{a:'enemyitem'},{a:'attack'},{a:'critical'},{a:'charge'},{a:'enemyguard'},{a:'attack'}],weakness:10,bgm:'./BGM/battlebgm_rare.ogg',growth:{hp:1.01,at:1.12,df:1.08,sp:1.05},healRate:0},
  ...
  {id:32,name:'Metal Bear (OP)',maxLv:5,drops:[53,13,20,8],coinRange:[100,300],expRange:[1500,4000],hp1:100,at1:20,df1:9999,sp1:60,type:'undeadboss',bossDialog:[],floorRange:[90,90],patterns:[{a:'enemyitem'},{a:'attack'},{a:'enemyguard'},{a:'critical'},{a:'attack'},{a:'attack'},{a:'counter'},{a:'enemyitem'},{a:'attack'},{a:'critical'},{a:'heal'},{a:'heal'},{a:'selfdestruct'}],weakness:10,bgm:'./BGM/battlebgm_rare.ogg',growth:{hp:1.1,at:1.25,df:1.2,sp:1.1},healRate:0.3},
  {id:33,name:'Gold Bear (OP)',maxLv:5,drops:[53,19,20,8],coinRange:[1000,3000],expRange:[150,400],hp1:120,at1:40,df1:9999,sp1:30,type:'doubleboss',bossDialog:[],floorRange:[95,95],patterns:[{a:'charge'},{a:'charge'},{a:'enemycharge'},{a:'enemyitem'},{a:'attack'},{a:'critical'},{a:'charge'},{a:'enemyguard'},{a:'attack'}],weakness:10,bgm:'./BGM/battlebgm_rare.ogg',growth:{hp:1.1,at:1.25,df:1.2,sp:1.1},healRate:0},
  ...
  {id:60,name:'Malara',maxLv:2,drops:[7,45,46,46,10,10,10,1,1,1,2,1,1,1,2],coinRange:[10,20],expRange:[7,27],hp1:10,at1:10,df1:5,sp1:15,type:'normal',bossDialog:[],floorRange:[11,30],patterns:[{a:'critical'},{a:'charge'},{a:'attack'},{a:'critical'},{a:'heal'},{a:'selfdestruct'}],weakness:12,bgm:'./BGM/battlebgm_speed2.ogg',growth:{hp:1.5,at:1.12,df:1.08,sp:1.05},healRate:0.3},
